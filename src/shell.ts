...
import "@vandeurenglenn/lite-elements/custom-pages.js";
import "@vandeurenglenn/lite-elements/custom-svg-icon.js";
import "@vandeurenglenn/lite-elements/custom-svg-iconset.js";
import "@vandeurenglenn/lite-elements/custom-selector.js";
...
export default customElements.define(
  "dimac-shell",
  class DimacShell extends LiteElement {
    #hashBang = "#!/";
    ...
    async #onhashchange() {
      ...
      if (!location.hash || !this.#validView(hash))
        return (location.hash = this.#addHashBang("home"));
      if (!customElements.get(`${hash}-view`)) await import(`./${hash}.js`);
      if (
        this.shadowRoot
          .querySelector(`${hash}-view`)
          .shadowRoot.querySelector("img.logo")
      ) {
        this.shadowRoot
          .querySelector(`${hash}-view`)
          .shadowRoot.querySelector("img.logo").src =
          this.shadowRoot.querySelector("img.logo").src;
      }
      ...
      return html`
        <style>
          :host {
            ...
            --main-background-overlay: #0a0d34;
            --hero-background: #fff;
            --primary-text-color: #fff;
            --accent-color: #db6829;
            --hero-border-color: none;
            --main-input-color: #1072f9;
            --main-button-color: #eee;
            --main-button-background: #1072f9;
            --main-input-background: #fff;
            --main-background-color: #fff;
            --drawer-background: #375167;
            --drawer-width: 256px;
        ...
        <header>
          <flex-row class="container">
            ...
            <a title="home" class="logo" href="/"
              ><img class="logo" alt="logo" src="./assets/dimac-dark.svg"
            /></a>
          </flex-row>
        </header>
