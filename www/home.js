...
var home = customElements.define('home-view', class extends s {
  constructor() {
    super();
  ...
  async #init() {
    ...
    this.shadowRoot.querySelector('main').addEventListener('scroll', () => document.dispatchEvent(new CustomEvent('custom-scroll', { detail: this.shadowRoot.querySelector('main') })));
    // this.startTyping()
  }
